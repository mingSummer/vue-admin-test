      ...
      <template>
        <div class="sales-view-chart-wrapper">
          ...
          <div class="sales-view-list">
            <div class="sales-list-title">排行榜</div>
...
<style lang="scss" scoped>
  ...
  .sales-view .menu-wrapper {
    position: relative;
    display: flex;
  }
  .sales-view .menu-wrapper .sales-view-menu {
    width: 100%;
    padding-left: 20px;
  }
  .sales-view .menu-wrapper .menu-right {
    position: absolute;
    top: 0;
    right: 20px;
    height: 50px;
  ...
  .sales-view .menu-wrapper .menu-right .sales-view-date-picker {
    margin-left: 20px;
  }
  .sales-view .menu-wrapper .sales-view-menu .el-menu-item {
    height: 50px;
    line-height: 50px;
    margin: 0 20px;
  }
